    ...
    draw(0, 10, "error : ");
      switch(chip_num){
        case 7400:
          ...
          draw(26,50,"1");
          draw(73,50,"2");
          if(result[0] != result7400) draw(48-8,30,"xxx");
          if(result[1] != result7400) draw(95-8,30,"xxx");
          if(result[2] != result7400) draw(26-8,50,"xxx");
          if(result[3] != result7400) draw(73-8,50,"xxx");
          break;
        case 7402:
          draw(70,10,"7402");
          draw(48,30,"4");
          ...
          draw(26,50,"1");
          draw(73,50,"2");
          if(result[0] != result7402) draw(48-8,30,"xxx");
          if(result[1] != result7402) draw(95-8,30,"xxx");
          if(result[2] != result7402) draw(26-8,50,"xxx");
          if(result[3] != result7402) draw(73-8,50,"xxx");
          break;
        case 7404:
          draw(70,10,"7404");
          draw(33,30,"6");
          ...
          draw(48,50,"2");
          draw(81,50,"3");
          if(result[0] != result7404) draw(33-8,30,"xxx");
          if(result[1] != result7404) draw(66-8,30,"xxx");
          if(result7404_test1 != result7404) draw(99-8,30,"xxx");
          if(result[2] != result7404) draw(15-8,50,"xxx");
          if(result[3] != result7404) draw(48-8,50,"xxx");
          if(result7404_test2 != result7404) draw(81-8,50,"xxx");
          break;
        case 7408:
          draw(70,10,"7408");
          draw(48,30,"4");
          ...
          draw(26,50,"1");
          draw(73,50,"2");
          if(result[0] != result7408) draw(48-8,30,"xxx");
          if(result[1] != result7408) draw(95-8,30,"xxx");
          if(result[2] != result7408) draw(26-8,50,"xxx");
          if(result[3] != result7408) draw(73-8,50,"xxx");
          break;
        case 7432:
          draw(70,10,"7432");
          draw(48,30,"4");
          ...
          draw(26,50,"1");
          draw(73,50,"2");
          if(result[0] != result7432) draw(48-8,30,"xxx");
          if(result[1] != result7432) draw(95-8,30,"xxx");
          if(result[2] != result7432) draw(26-8,50,"xxx");
          if(result[3] != result7432) draw(73-8,50,"xxx");
          break;
        case 7486:
          draw(70,10,"7486");
          draw(48,30,"4");
          ...
          draw(26,50,"1");
          draw(73,50,"2");
          if(result[0] != result7486) draw(48-8,30,"xxx");
          if(result[1] != result7486) draw(95-8,30,"xxx");
          if(result[2] != result7486) draw(26-8,50,"xxx");
          if(result[3] != result7486) draw(73-8,50,"xxx");
          break; 
      }
    } while( u8g.nextPage() );
  mode = 24;
